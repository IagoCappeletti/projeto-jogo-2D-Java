# Projeto de desenvolvimento de um jogo 2D.
...
Funcionalidades: O projeto incluirá a criação de um jogo 2D que terá personagens principal, personagens inimigos, cenário, colisões e controles de jogador. O jogo terá uma mecânica de jogo simples,, onde o jogador terá que alcançar um objetivo para vencer. O jogo também incluirá som e efeitos visuais para melhorar a experiência do usuário.
